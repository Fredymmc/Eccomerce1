...
let stockProductos = [
    {id: 1, nombre: "iPhone 13 Pro", tipo: "Apple", cantidad: 1, desc: "Celular Apple iPhone 13 pro", precio: 1020, img: './img/cellphone01.jpg'},
    {id: 2, nombre: "Redmi Note 11 Pro", tipo: "Xiaomi", cantidad: 1, desc: "Xiaomi Redmi Note 11 Pro", precio: 400, img: './img/cellphone02.jpg'},
    {id: 3, nombre: "iPhone 13 ", tipo: "iPhone", cantidad: 1, desc: "Celular Xiaomi Poco M4", precio: 900, img: './img/cellphone03.jpg'},
    {id: 4, nombre: "Xiaomi Poco M4 ", tipo: "Xiaomi", cantidad: 1, desc: "Celular Xiaomi Poco M4", precio: 350, img: './img/cellphone04.jpg'},
    {id: 5, nombre: "UMIDIGI BISON 6GB ", tipo: "UMIDIGI", cantidad: 1, desc: "Celular UMIDIGI BISON 6GB", precio: 100, img: './img/cellphone05.jpg'},
    {id: 6, nombre: "Motorola Moto G60 ", tipo: "Motorola", cantidad: 1, desc: "Celular Motorola Moto G60", precio: 400, img: './img/cellphone06.jpg'},
]
...
stockProductos.forEach((producto) => {
    ...
    <h3 class="titulo2">${producto.nombre}</h3>
    <p>${producto.desc}</p>
    <p class="precioProducto"> <span>Precio:</span> $${producto.precio}</p>
